...
// Data Definition (Ordered V1-V13)
const mods = {
    v1: {
...
window.renderMods = (filterCategory) => {
    ...
    const filterBtn = document.getElementById(`filter-${filterCategory}`);
    if (filterBtn) {
    ...
    if (count === 0) {
        grid.innerHTML = `
            <div class="empty-state">
                ...
                <h3>BELUM ADA MODS YANG TERSEDIA</h3>
                <p>Silakan cek kategori lain atau kembali lagi nanti.</p>
            </div>
        `;
    }
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Explicitly bind the Explore Mod button
